      ...
      <ul class="right hide-on-med-and-down">
        <li><a class="waves-effect waves-light btn" href="/">HOME</a></li>
		  ...
		  <div class="row">
            ...
            <div class="col m6"> 
		        <h2 class="center-align" style="position:relative; left:15vw;"> Nothing Found !!</h2><br>


		       <h3 class="center-align" style="position:relative; left:15vw;"> Don't worry you can report here .</h3>
