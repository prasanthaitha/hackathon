...
<head>
  ...
  <link href="css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
   ...
   <div class="row">
        ...
        <form action="{{URL::to('updateInfo')}}" method="post">
              {{csrf_field()}}
      ...
      <div class="row">
          ...
          <input id="c/u" type="text" class="validate" name="uname" value="{{$universities->uname}}"required>
      ...
      <div class="input-field col s6">
          ...
          <input id="address" type="text" class="validate" name="city" value="{{$universities->city}}" required>
      ...
      <div class="input-field col s6">
          ...
          <input id="address" type="text" class="validate" name="state" value="{{$universities->state}}" required>
